...
describe("obj", function() {
  ...
  it("getIn", function() {
    expect(24).equal(koyo.getIn(obj1, ["bar", "baz"]));
  });

  it("update", function() {
    var updated = koyo.update(obj1, "foo", function(val) { return val + 1; });
  ...
  it("updateIn", function() {
    var seen,
        updated = koyo.updateIn2(obj1, ["bar", "zork"], function(val) {
          seen = val; return 99; });
...
describe("collection", function() {
  ...
  it("reduced", function() {
    var result = koyo.reduced([1,2,3,4], function(akk, ea) { return akk + ea; }, 0);
